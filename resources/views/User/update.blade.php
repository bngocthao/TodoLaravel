                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="gender" class="form-control">
                                <option @if($users -> gender == 1) selected @endif value="1">Nam</option>
                                <option @if($users -> gender == 2) selected @endif value="2">Nữ</option>
                                <option @if($users -> gender == 3) selected @endif value="3">Khác</option>
                            </select>
                        </div>
                    </div>
