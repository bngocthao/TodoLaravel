...
{{--                                    <span>{{ $projectsName->nameProject }}</span>--}}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4><strong>{{ $projectsName->nameProject }}</strong></h4>
                                    <div class="card-header-right">
                                        <ul class="list-unstyled card-option">
                                            <span>Bắt đầu: {{ date('d-m-y', strtotime($projectsName->start_at)) }}</span>
                                            <span>Kết thúc: {{ date('d-m-y',  strtotime($projectsName->end_at)) }}</span>
                                            <br>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card-block " style="">
                                    <p class="col-lg-8" >
                                        <img class="col-lg-12" src="/project_upload/{{ $projectsName->image}}"></img>
                                    </p>
                                </div>
                                <div class="card-block " style="">
                                    <p class="col-lg-8" >
