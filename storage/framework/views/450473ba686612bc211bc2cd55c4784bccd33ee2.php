            ...
            <div class="card-block">
                ...
                <form action="<?php echo e(route('accounts.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input required name="accountCode" type="text" class="form-control" value="<?php echo e($accountCode); ?>" style="color: red; font-weight: bold">
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\CODE\Working\TodoLaravel\resources\views/Account/create.blade.php ENDPATH**/ ?>