                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4><strong><?php echo e($projectsName->nameProject); ?></strong></h4>
                                    <div class="card-header-right">
                                        <ul class="list-unstyled card-option">
                                            <span>Bắt đầu: <?php echo e(date('d-m-y', strtotime($projectsName->start_at))); ?></span>
                                            <span>Kết thúc: <?php echo e(date('d-m-y',  strtotime($projectsName->end_at))); ?></span>
                                            <br>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card-block " style="">
                                    <p class="col-lg-8" >
                                        <?php echo $projectsName->description; ?>
