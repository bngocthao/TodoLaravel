...
<?php $__env->startSection('content'); ?>
    ...
    <form id="accesspanel" action="<?php echo e(route('login')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <h1 id="litheader"></h1>
        <div class="inset">
            <p>
...
unset($__errorArgs, $__bag); ?>
        ...
        <p class="p-container">
            <input type="submit" name="Login" id="go" value=<?php echo e(__('Login')); ?>>
        </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project-Management-Laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>