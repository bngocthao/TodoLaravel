    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card-header">
                <h2>Danh sách tài khoản <a href="<?php echo e(route('accounts.create')); ?>" class="btn btn-danger">Thêm mới tài khoản</a></h2>
            </div>
                                            ...
                                            <tr role="row" class="odd">
                                                <td>
                                                    <span class="media-left media-middle" href="#">
                                                        <img style="max-width: 100px" class="media-object m-r-10 m-l-10" src="/avatar_upload/<?php echo e($item->avatar); ?>" alt="Chưa có ảnh đại diện">
                                                    </span>
                                                </td>
                                                <td><?php echo e($item->accountCode); ?></td>
                                                <td><?php echo e($item->fullName); ?></td>

                                                <td><?php echo e($item->department->departmentName); ?></td>
                                                <td><?php echo e($item->position->positionName); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('accounts.edit', $item)); ?>">Chỉnh sửa</a>
                                                            <form method="POST" action=" <?php echo e(route('accounts.destroy', $item)); ?>">
                                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\CODE\Working\TodoLaravel\resources\views/Account/index.blade.php ENDPATH**/ ?>