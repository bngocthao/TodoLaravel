        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 style="font-weight: bold">QUẢN LÝ CHỨC VỤ <a href="<?php echo e(route('positions.create')); ?>" style="font-weight: bold; color: white" class="btn btn-success">Thêm mới chức vụ</a></h3>
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\CODE\Working\TodoLaravel\resources\views/Position/index.blade.php ENDPATH**/ ?>