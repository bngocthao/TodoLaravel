            ...
            <div class="card-block">
                ...
                <form action="<?php echo e(route('departments.store')); ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input required name="departmentDes" type="text" class="form-control" placeholder="Thông tin phòng ban">
                        </div>
                    </div>
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\CODE\Working\TodoLaravel\resources\views/Department/create.blade.php ENDPATH**/ ?>