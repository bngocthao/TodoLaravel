            ...
            <div class="card-block">
                ...
                <form action="<?php echo e(route('positions.update', $positions)); ?>" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input required name="positionDes" type="text" class="form-control" value="<?php echo e($positions->positionDes); ?>">
                        </div>
                    </div>
...
<?php echo $__env->make('home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\CODE\Working\TodoLaravel\resources\views/Position/update.blade.php ENDPATH**/ ?>